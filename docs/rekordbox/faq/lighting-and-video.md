...
2. Open [FIXTURE LIBRARY] screen and click [+] button on the right. You can request addition via our Forum. Please note that we cannot guarantee that you can add any fixtures as you wish.
